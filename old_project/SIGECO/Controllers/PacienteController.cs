...
namespace SIGECO.Controllers
{
    public class PacienteController : Controller
    {
        ...
        public ActionResult List()
        {
            ...
            var db = new SIGECO_Entities();
            var consulta = db.TableColumns
                .Where(c => c.TABLE_NAME.Equals("Paciente") && c.HTML_LIST_SHOW==true)
                .OrderBy(c => c.ORDINAL_POSITION)
                .Select(c => c).ToList();

            ViewBag.Title = "Pacientes";
            ViewBag.SubTitle = "Control de Pacientes";
            ViewBag.FormTitle = "Pacientes Existentes";
            ViewBag.tblSchema = "dbo";
            ViewBag.tblName = "Paciente";

            return View("~/Views/GeneralForms/generalList.cshtml", consulta);
        }
